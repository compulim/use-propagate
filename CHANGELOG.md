...
- 👷🏻 Test framework moved to Node.js test runner, by [@compulim](https://github.com/compulim) in PR [#34](https://github.com/compulim/use-propagate/pull/34)

## [0.2.2] - 2025-12-23

### Changed

- Bumped dependencies, in PR [#31](https://github.com/compulim/use-propagate/pull/31)
